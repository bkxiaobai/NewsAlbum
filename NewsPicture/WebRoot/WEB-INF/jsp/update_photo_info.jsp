						...
						<td colspan="5"><div align="center">
								<html:form action="updatephotoInfo.do"
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<td>&nbsp;</td>
											<td height="25" class="Statistic2 STYLE1"><div align="left">图片名称:</div></td>
										...
										<tr>
											<td>&nbsp;</td>
											<td height="25" class="Statistic2 STYLE1"><div align="left">选择图集:</div></td>
										...
										<tr>
											<td>&nbsp;</td>
											<td height="25" class="Statistic2 STYLE1"><div align="left">图片描述:</div></td>
											<td>&nbsp;</td>
											<td>&nbsp;</td>
										</tr>
										<tr>
